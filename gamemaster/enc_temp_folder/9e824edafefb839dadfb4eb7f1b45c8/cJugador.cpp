...
cJugador::cJugador(JUGADORES jugador, string usuario, string contrasenia, int bajas, bool SigueJugando, cListaT<cPais>* listaPaises) :usuario(usuario), contrasenia(contrasenia), jugador(jugador)
{
	this->bajas = bajas;
